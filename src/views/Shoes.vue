<template>
    ...
    <div class="products__category"> 
      <div>
        ...
        <h1 v-for="title in categories" :key="title" v-show="title.title_ru == 'Обуви' && lang === 'ru'">{{title.title_ru}}</h1>
    <h1 v-for="title in categories" :key="title" v-show="title.title_ru == 'Обуви' && lang === 'uz'">{{title.title_uz}}</h1>
    <h1 v-for="title in categories" :key="title" v-show="title.title_ru == 'Обуви' && lang === 'en'">{{title.title_en}}</h1>
      </div>
    </div>
    <div class="products__clothes">
        <div v-show="product.category_title_uz == 'Poyabzallar'" v-for="product in products" :key="product">
