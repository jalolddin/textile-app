<template>
    ...
    <div class="products__category"> 
      <div>
        ...
        <h1 v-for="title in categories" :key="title" v-show="title.title_ru == 'Головные уборы' && lang === 'ru'">{{title.title_ru}}</h1>
    <h1 v-for="title in categories" :key="title" v-show="title.title_ru == 'Головные уборы' && lang === 'uz'">{{title.title_uz}}</h1>
    <h1 v-for="title in categories" :key="title" v-show="title.title_ru == 'Головные уборы' && lang === 'en'">{{title.title_en}}</h1>
      </div>
